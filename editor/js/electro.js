...
exports = {
  ...
  load: function(electro) {
    ...
    electro.getMeasurementsList().forEach(function(measurement) {
      const node = exports.addMeasurement();
      exports.loadMeasurement(node, measurement);
    });
  },

  loadMeasurement: function(node, measurement) {
  ...
  unload: function() {
    ...
    $('.electro_measurement').each(function(index, node) {
      node = $(node);
      if (!node.attr('id')) {
        const measurement = exports.unloadMeasurement(node);
  ...
  unloadMeasurement: function(node) {
  ...
  addMeasurement: function() {
    ...
    metricButtons.attr('name', 'electro_' + exports.radioGroupCounter++);
  ...
  validateElectro: function(node, validateNode) {
    const electro = exports.unload();
    if (!validateNode) {
